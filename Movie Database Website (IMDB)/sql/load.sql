...
INSERT INTO MaxPersonID (SELECT MAX(mid) FROM (SELECT MAX(id) as mid FROM Actor UNION SELECT MAX(id) as mid FROM Director) max);
INSERT INTO MaxMovieID (SELECT MAX(id) FROM Movie);
